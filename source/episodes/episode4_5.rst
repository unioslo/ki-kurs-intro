...
Kode-agenter som for eksempel Codex, OpenCode eller Claude Code er eksempler på slike applikasjoner.
Vi nevner disse spesielt er fordi de er så mye mer enn bare programmeringshjelpere. 
