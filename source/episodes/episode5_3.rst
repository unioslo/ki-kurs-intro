...
GPT UiO er UiOs personverntrygge KI-chat. Til forskjell fra ChatGPT som har utviklet seg til å bli en *agent*, så er GPT UiO kun en enkel chat tjeneste. 
Det betyr at den kun bruker en språkmodell til å genere et tekstsvar, og utfører ikke handlinger som f.eks. å gjøre nettsøk eller hente informasjon fra andre systemer. 

GPT UiO har allikevel en *assistent* funksjonalitet. Med den kan man lage egne instruksjoner som ligger som et ekstra lag i tillegg til instruksjonene i chaten, man kan laste opp filer, slik at når man gjør spørringer, så vil modellen lete gjennom filene og finne relevant informasjon som den benytter i svaret, og man kan velge en spesifikk modell som assistenten benytter. 
