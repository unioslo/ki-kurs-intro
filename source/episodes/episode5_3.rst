...
Det betyr at den kun bruker en språkmodell til å genere et tekstsvar, og har ikke annen funksjonalitet som f.eks. å gjøre internettsøk, hente ut informasjon fra andre systemer, eller utføre handlinger som for eksempel opprette/endre filer.
