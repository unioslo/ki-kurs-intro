...
Gemini kan også kobles til kilder du har lagret i Gemini Notebook, se nedenfor.

Gemini Notebook
----------------------------

Gemini Notebook er en KI-drevet assistent fra Google spesialisert for å arbeide med dokumenter.
Gemini Notebook vil ikke svare på noen spørsmål før du har lastet opp informasjon den kan bruke som kilde.
Gemini Notebook bruker Gemini som «motoren» som genererer tekst.

I Gemini Notebook bygger man seg først en egen "kunnskapsbank" som inneholder dokumenter og nettsider, eller til og med opptak fra forelesninger. 
Dette er grunnlaget Gemini Notebook benytter for å generere svar på spørsmål.
Gemini Notebook har også en hel del spennende funksjoner for å lage f.eks. oppsummeringer i tekst eller lyd, quizer eller presentasjoner. 

Gemini Notebook forsøker å være tro mot kildene du benytter, og du kan derfor oppleve å få mer presise svar enn for eksempel ved bruk av gpt.uio.no. 
...
.. uio-dont:: Viktig
   ...
   * Ikke last opp dokumenter som inneholder sensitiv informasjon. Gemini Notebook og Gemini er kun godkjent for opptil gule data.
