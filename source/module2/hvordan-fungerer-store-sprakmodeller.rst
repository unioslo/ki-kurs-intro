...
Den kan heller ikke "huske" informasjon fra tidligere samtaler, det skal vi lære mer om i `Språkmodeller har ikke hukommelse <module1/sprakmodeller-har-ikke-hukommelse>`_. 
