...
Teknologi gjennombrudd
----------------------------------

Moderne LLM-er er bygget på revolusjonerende teknologi (transformer deep neural networks) som gjør at de kan se på hele teksten samtidig og forstå sammenhenger.
